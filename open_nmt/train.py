...
"""
    ...
    This uses OpenNMT github code: https://github.com/OpenNMT/OpenNMT-py.
    Make sure you change the environment to nmtpy2 env.
    Use open_nmt.sh script. It show cases how to use train and translate.
"""
